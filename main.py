...
questions, result = stackexchange.getQuestions("Comments.xml", "Posts.xml")
...
for question in questions:
    output.write('<li><a href="https://codereview.stackexchange.com/questions/' + str(question) +'">' + 'Question ' + str(question) + '</a> has ' + str(result) + ' comments posted between midnight and 6 a.m.</li>\n')
output.write('</ul>\n</body>\n</html>')
print("Done")
output.close()